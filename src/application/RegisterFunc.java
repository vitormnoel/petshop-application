 ...
 * @author Vitor Manoel
 */
public class RegisterFunc extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, -1, 30));
        ...
        getContentPane().add(label_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 80, 60, 30));

        label_email.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        label_email.setForeground(new java.awt.Color(209, 155, 52));
        label_email.setText("Email:");
        getContentPane().add(label_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 280, 70, 30));
        ...
        getContentPane().add(label_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 330, 80, 30));
        ...
        getContentPane().add(label_cpf, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 130, 60, 30));
        ...
        getContentPane().add(label_tel, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 80, 30));
        ...
        getContentPane().add(label_adress, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 90, 30));
        ...
        getContentPane().add(text_conf_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 380, 190, 30));
        ...
        getContentPane().add(text_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 330, 280, 30));
        ...
        getContentPane().add(text_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 280, 280, 30));
        ...
        getContentPane().add(text_tel, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 230, 250, 30));
        ...
        getContentPane().add(text_adress, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 180, 250, 30));
        ...
        getContentPane().add(text_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, 280, 30));
        ...
        getContentPane().add(text_cpf, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 130, 300, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new RegisterFunc().setVisible(true);
        });
    }
